      ...
      >
        <Card className="shadow-2xl">
          <CardHeader className="text-center space-y-2">
            ...
            <CardTitle className="text-2xl font-black">MalGuard AI Portal</CardTitle>
            <CardDescription>Authenticate to access threat intelligence features</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full mt-2 glow-blue" disabled={loading}>
                {loading ? (
